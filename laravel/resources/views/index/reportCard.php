	...
	<body>
		...
		<ul class="dorm-book mt3">
			...
			<li>
		        ...
		        <span class="info-middle"><?php echo $v['uname'] ?></span>  
			</li>
			<li>
			...
			<li>
		        ...
		        <span class="info-middle"><?php echo $v['card'] ?></span>  
			</li>
			<li>
				<span class="book-tit">考生号</span>
		    <span class="info-middle"><?php echo $v['number'] ?></span>  
			</li>
			<li>
				<span class="book-tit">学院</span>
		        <span class="info-middle"><?php echo $v['college'] ?></span>  
			</li>
			<li>
				<span class="book-tit">专业</span>
		        <span class="info-middle"><?php echo $v['major'] ?></span>  
			</li>
			<li>
